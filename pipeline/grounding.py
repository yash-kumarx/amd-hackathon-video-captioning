...
SYSTEM = (
    ...
    "If unsure, put it in uncertainty_notes (never a guessed answer — write 'exact city uncertain', "
    "not 'may be Tokyo'). Do NOT infer an exact city, country, brand, org, or transit agency from "
    "logos, plates, or partial signs unless the name itself is clearly readable — use generic wording "
    "('city street', 'office', 'indoor room'). For ambiguous close-ups prefer the most common everyday "
